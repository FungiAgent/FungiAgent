    ...
    new DynamicStructuredTool({
        ...
        schema: z.object({
            ...
            fromToken: z
                .string()
                .describe(
                    "The address of the token to transfer from the source chain",
                ),
            toChain: z
                .string()
                .describe(
    ...
    new DynamicStructuredTool({
        ...
        schema: z.object({
            ...
            toAddress: z
                .string()
                .describe(
                    "The address to receive the tokens on the destination chain",
                ),
            slippage: z
                .string()
    ...
    new DynamicStructuredTool({
        ...
        schema: z.object({
            ...
            searchDepth: z
                ...
                .default("basic")
                .describe(
                    "The depth of the search, e.g., 'basic' or 'detailed'",
                ),
            includeImages: z
                .boolean()
                .optional()
            ...
            includeAnswer: z
                ...
                .default(false)
                .describe(
                    "Whether to include a direct answer in the search results",
                ),
            includeRawContent: z
                .boolean()
                .optional()
            ...
            includeDomains: z
                ...
                .default([])
                .describe(
                    "Domains to specifically include in the search results",
                ),
            excludeDomains: z
                .array(z.string())
                .optional()
    ...
    new DynamicStructuredTool({
        ...
        schema: z.object({
            account: z
                .string()
                .describe(
                    "The account identifier for which to fetch activities.",
                ),
            network: z
                .array(z.string())
                .optional()
            ...
            status: z
                ...
                .optional()
                .describe(
                    "Filter activities by status: 'failed' or 'successful'.",
                ),
        }),
        func: async ({
            account,
            ...
            try {
                const results = await RSS3Search(
                    ...
                    {
                        onLoading: () =>
                            console.log("Loading RSS3 activities..."),
                        onResult: (result) =>
                            console.log("Fetched RSS3 data:", result),
                        onError: (error) =>
