...
const TxSummarySimple = ({ amountWithDecimals, tokenInSymbol, recipient, gasCost, tokenInLogo }) => {
  ...
  return (
    <div className="flex justify-between items-center h-[38px] rounded-full bg-white w-[454px] shadow">
      <div className="flex items-center pl-5">
        ...
        <span className="mr-4">{amountWithDecimals} {tokenInSymbol} to {getShortAddress(recipient)}</span>
      </div>
