 ...
 * 
*/
export const getLiFiQuote = async (fromChain: string, toChain: string, fromToken: string, toToken: string, fromAmount: string, fromAddress: string, slippage: string): Promise<object> => {
    try {
